...
export default function TerminalPane({ onCommand, activePanel }: TerminalPaneProps) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter') {
      ...
      if (!val) return
      const COMMANDS = ['help', 'whoami', 'skills', 'experience', 'exp', 'awards', 'skyfallen', 'origin', 'contact', 'back', 'home', 'cd', 'clear', 'ls', 'pwd', 'date', 'echo', 'neofetch', 'secret', 'uname', 'github', 'email', 'resume', 'cv', 'kucukrobotcuk', 'blog']
